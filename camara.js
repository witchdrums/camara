...
async function uploadFile(blob){
    ...
    const urlAzure = "https://alejandrochaconfernandezs20015745ingenieriadesoftwwebapifoto.azurewebsites.net"
    ...
    if (response.status === 201) {
        ...
        alert("Ocurrió algo al intentar subir la imagen: " + response.statusText);
    }
}